...
<?php if ($this->options->WebPjax): ?>
  ...
  <script>
    $(document).pjax('a[href^="<?php Helper::options()->siteUrl()?>"]:not(a[target="_blank"],a[no-pjax]), a[href^="?"], a[href^="/"]', {
        container: '#pjax-load',
        fragment: '#pjax-load',
        timeout: 8000
        ...
        if (typeof MathJax !== 'undefined' && typeof MathJax.typeset !== 'undefined') { MathJax.typeset(); }
    ...
    $(document).on('pjax:success', function() {
        $.getScript('<?php $this->options->themeUrl('/assets/js/features.js'); ?>');
        $.getScript('<?php $this->options->themeUrl('/assets/js/codecopy.js'); ?>');
        $.getScript('<?php $this->options->themeUrl('/assets/js/toc.js'); ?>');
    });
  </script>
<?php endif; ?>
